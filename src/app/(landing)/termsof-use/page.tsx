...
export const metadata = {
	title: "Terms Of Us - What should I watch",
	description:
		"Check out our terms of service and explore policies for using our platform on our Terms of Use page",
};
		...
		<div className="w-full bg-white">
			<div className="container mx-auto p-6">
				...
				<h1 className="mb-6  text-4xl font-semibold">
					Privacy Policy for What Should I Watch
				</h1>
				<p className="mb-5">Last updated: August 30, 2023</p>
				<p className="mb-5">
				...
				<h2 className="mb-6 text-3xl font-semibold">Interpretation</h2>
				<p className="mb-5">
				...
				<h2 className="mb-6 text-3xl font-semibold">Definitions</h2>
				...
				<ul className="list-disc pl-8 ">
					...
					<li>
						<p className="mb-5">
							...
							in this Agreement) refers to what-should-i-watch.
						</p>
					</li>
					<li>
						<p className="mb-5">
					...
					<li>
						<p className="mb-5">
							<strong>Country</strong> refers to: Ankara, Turkey
						</p>
					</li>
					<li>
						<p className="mb-5">
					...
					<li>
						<p className="mb-5">
							<strong>Website</strong> refers to what-should-i-watch, accessible
							from{" "}
							<Link
								className="underline" //TODO: Site Linki Güncellenmeli.
								href={`https://${host}/`}
				...
				<h2 className="mb-6 text-3xl font-semibold">Types of Data Collected</h2>
				<h3 className="mb-6 text-2xl font-semibold">Personal Data</h3>
				<p className="mb-6">
				...
				<ul className="list-disc pl-8">
					...
					<li>
						<p className="mb-3">First name and last name</p>
					</li>
					<li>
					...
					<li>
						<p className="mb-3">Usage Data</p>
					</li>
				</ul>
				<h3 className="mb-6 text-2xl font-semibold">Usage Data</h3>
				<p className="mb-6">
				...
				<ul className="list-disc pl-8">
					<li>
						...
						<p className="mb-3">Type: Session Cookies</p>
						<p className="mb-3">Administered by: Us</p>
						<p className="mb-6">
					...
					<li>
						...
						<p className="mb-3">Type: Persistent Cookies</p>
						<p className="mb-3">Type: Persistent Cookies</p>
						<p className="mb-3">Administered by: Us</p>
						<p className="mb-3">
				...
				<h3 className="mb-6 text-2xl font-semibold">Business Transactions</h3>
				<p className="mb-6">
				...
				<h3 className="mb-6 text-2xl font-semibold">Law enforcement</h3>
				<p className="mb-6">
				...
				<ul className="list-disc pl-8">
					<li className="mb-3">Comply with a legal obligation</li>
					<li className="mb-3">
					...
					<li className="mb-3">Protect against legal liability</li>
				</ul>
				<h2 className="mb-6 text-3xl font-semibold">
				...
				<h1 className="mb-6 text-4xl font-semibold">Children's Privacy</h1>
				<p className="mb-6">
